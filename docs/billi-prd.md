...
- Streaming speech-to-text via Deepgram (key in local `.env` as `DEEPGRAM_API_KEY`, never committed), with partial transcripts shown live, plus an explicit "go" affordance for noisy or sensitive moments.
